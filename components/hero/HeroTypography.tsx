...
export function HeroTypography() {
  return (
    <div className="flex flex-col space-y-3 z-20">
      ...
      >
        <span className="inline-block w-2 h-2 rounded-full bg-[#FF174F] animate-pulse" />
      ...
      >
        <p className="font-mono text-xs sm:text-sm tracking-wider text-[#929292] uppercase">
          DATA <span className="text-[#FF174F]">•</span> DESIGN{" "}
          <span className="text-[#FF174F]">•</span> EDIT{" "}
          <span className="text-[#FF174F]">•</span> CREATIVE{" "}
          <span className="text-[#FF174F]">•</span> DETERMINED
        </p>
      </motion.div>
    </div>
  );
